		...
		<div class="inner__banner">
			...
			<div class="inner__banner-in grid__inner">
				<div class="inner__banner-block">
					<div class="inner__banner-title">Пополняемый депозит</div>
			...
			<div class="grid__inner">
					...
					<div class="numerals">
						<div class="numerals__block">
							<div class="numerals__item _big">
								<div class="numerals__item-val">7,90%</div>
				...
				<div class="inner__info-benefits">
					...
					<ul class="b-list">
						...
						<li>Возможность пополнения депозита</li>
					</ul>
						...
						<div class="deposit-info__block">
							...
							<div class="deposit-conditions">
								...
								<div class="deposit-conditions__item">
									...
									<div class="deposit-conditions__item-block">возможно</div>
								</div>
								<div class="deposit-conditions__item">
									<div class="deposit-conditions__item-block">Срок размещения</div>
									<div class="deposit-conditions__item-block">минимальный − 91 день, максимальный − 546 дней</div>
								</div>
								<div class="deposit-conditions__item">
									<div class="deposit-conditions__item-block">Минимальная сумма размещения</div>
									<div class="deposit-conditions__item-block">100 000 рублей</div>
								</div>
								<div class="deposit-conditions__item">
										...
										<div class="deposit-scale__table" data-tabs-content="1">
											<table>
												<tr class="deposit-scale__table-titles">
													...
													<td>от 100 000<br/>до 50 000 000</td>
													<td>от 50 000 000</td>
												</tr>
					...
					<div class="deposit-scale">
						...
						<div class="deposit-table__wrap">
							<table class="deposit-table _rowspan-table _reverse-indents">
								...
								<tr>
									<th colspan="2" class="_left">Период пополнения</th>
									<th>61</th>
									<th>121</th>
									<th>181</th>
									<th>241</th>
