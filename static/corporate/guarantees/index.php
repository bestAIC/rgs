	...
	<div class="inner deposit">
		<div class="inner__banner">
			<div class="inner__banner-img">
				<div class="inner__banner-img-in" style="background-image: url('/static/theme/images/banners/corporate/guarantees.jpg');"></div>
			</div>
			<div class="inner__banner-in grid__inner">
				<div class="inner__banner-block">
					<div class="inner__banner-title">Банковские гарантии</div>
			...
			<div class="grid__inner">
				<div class="inner__info-block">
					...
					<div class="frame-text is-desktop-block">
						...
						финансовых показателей компании, вида и размера предоставленного обеспечения.
					</div>
				</div>
