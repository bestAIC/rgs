	...
	<div class="inner deposit depository">
		...
		<div class="b-blocks _gray">
			<div class="b-block animation__top depository__news"  data-animation>
				<div class="grid__inner">
					<h2><a href="javascript:void(0);" class="news-gall__tab _active">Новости депозитария</a> / <a href="javascript:void(0);" class="news-gall__tab">корпоративные действия</a></h2>
					<div class="depository__form">
						<form action="">
							<div class="depository__form-inner">
								<div class="depository__form-title">Найти сообщения</div>
								<div class="depository__form-fields">
									<div class="depository__form-field">
										<select data-chosen data-placeholder="Месяц">
											<option>Месяц</option>
									...
									<div class="depository__form-field">
										<select data-chosen data-placeholder="Год">
											<option>Год</option>
											<option>2016</option>
											<option>2017</option>
										</select>
					...
					<div class="depository__news-block">
						...
						<div class="gall__news depository__news-item _flag">
							<div class="gall__news-inner">
								<div class="gall__news-date">29 декабря 2016</div>
								<a href="#" class="gall__news-title">
									Вниманию клиентов: работа отделений РОСГОССТРАХ БАНКА в новогодние и рождественские праздники 2017 года
					...
					<div class="gold-link__wrap">
						<a href="javascript:void(0);" class="gold-link _arr-down">Показать ещё</a>
					</div>
				</div>
			</div>
