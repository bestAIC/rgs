	...
	<div class="inner deposit">
		<div class="inner__banner">
			<div class="inner__banner-img">
				<div class="inner__banner-img-in" style="background-image: url('/static/theme/images/banners/deposit/Deposit_Universal.png');"></div>
			</div>
			<div class="inner__banner-in grid__inner">
				<div class="inner__banner-block">
					<div class="inner__banner-title">Вклад «Универсальный&nbsp;VIP»</div>
					<div class="breadcrumbs">
						...
						<div class="breadcrumbs__item">
							<span>Вклад «Универсальный VIP»</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="grid__inner">
				...
				<div class="inner__info-benefits">
					<div class="inner__info-benefits-title">
						Вклад для состоятельных клиентов с возможностью пополнения и снятия средств до неснижаемого остатка
					</div>
					<ul class="b-list">
		...
		<div class="b-blocks">
			<?include "../includes/calcs/universalVip.php"?>
							...
							<div class="deposit-table__wrap">
								<table class="deposit-table _rowspan-table">
									...
									<tr class="deposit-table__row _grey">
										<td class="center bold valuta"><span class="rub"></span></td>
										<td >от 1 000 000</td>
										<td class="center bold">7,30</td>
									</tr>
									<tr class="deposit-table__row">
										<td class="center bold valuta">$</td>
										<td>от 15 000</td>
										<td class="center bold">1,40</td>
									</tr>
									<tr class="deposit-table__row _grey">
										<td class="center bold valuta">€</td>
										<td>от 15 000</td>
						...
						<div class="deposit-info__block">
							...
							<div class="deposit-conditions">
								...
								<div class="deposit-conditions__item">
									...
									<div class="deposit-conditions__item-block">
										1 000 000 рублей /
										15 000 долларов США / 15 000 евро
									</div>
								</div>
								<div class="deposit-conditions__item">
									<div class="deposit-conditions__item-block">Пополнение вклада</div>
									<div class="deposit-conditions__item-block">
										предусмотрено, дополнительные взносы принимаются не позднее, чем за 1 месяц до окончания срока вклада
									</div>
								</div>
								<div class="deposit-conditions__item">
									<div class="deposit-conditions__item-block">
									...
									<div class="deposit-conditions__item-block">1  000 рублей / 50 долларов США
										/ 50 евро</div>
								</div>
								<div class="deposit-conditions__item">
									<div class="deposit-conditions__item-block">Частичное снятие вклада</div>
									<div class="deposit-conditions__item-block">предусмотрено, при условии
										сохранения неснижаемого остатка*
										на вкладе</div>
								</div>
								<div class="deposit-conditions__item">
