		...
		<div class="inner__banner" style="background-image: url('/static/theme/images/inner/banner.jpg');">
			<div class="inner__banner-in grid__inner">
				<div class="inner__banner-block">
					<div class="inner__banner-title">Вклад «Инвестиционный»</div>
					<div class="breadcrumbs">
						...
						<div class="breadcrumbs__item">
							<span>Вклад «Инвестиционный»</span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="inner__info animation__top"  data-animation>
			<div class="grid__inner">
				<div class="inner__info-block">
					<div class="numerals _only-big">
						<div class="numerals__block">
							<div class="numerals__item _big">
								<div class="numerals__item-val">9,50%</div>
				...
				<div class="inner__info-benefits">
					<div class="inner__info-benefits-title">
						Высокодоходный вклад с возможностью получить страховую защиту жизни и здоровья или дополнительный доход от вложения средств в ПИФы
					</div>
					<div class="inner__info-benefits-text">
						Позволяет получить более высокую доходность сбережений за счет комбинации гарантированного дохода на сумму вклада и возможности получения дополнительного инвестиционного дохода от вложения средств в паи ПИФов
						под управлением ООО «Управление Сбережениями» или получить страховую защиту жизни и здоровья при заключении договора страхования жизни
							...
							<div class="deposit-table__wrap">
								<table class="deposit-table">
									...
									<tr class="deposit-table__row">
										...
										<td class="center bold">9,50</td>
										<td class="center bold">9,00</td>
									</tr>
								</table>
							</div>
							<div class="deposit__text">
								<p>Агентством по страхованию вкладов застрахована только сумма вклада, сумма пая (паев) страхованию не подлежит.</p>
								<p>Примечание: В случаях, установленных законодательством РФ, с суммы доходов удерживается налог на доходы физических лиц.</p>
							</div>
						</div>
						<div class="deposit-info__block">
							...
							<div class="deposit-conditions">
								<div class="deposit-conditions__item">
									<div class="deposit-conditions__item-block">Тип вклада</div>
									<div class="deposit-conditions__item-block">срочный</div>
								</div>
								<div class="deposit-conditions__item">
									<div class="deposit-conditions__item-block">Валюта вклада</div>
									<div class="deposit-conditions__item-block">рубли, доллары США, евро</div>
								</div>
								<div class="deposit-conditions__item">
									<div class="deposit-conditions__item-block">Срок размещения</div>
									<div class="deposit-conditions__item-block">
										минимальный - 181 день,
										максимальный - 732 дня
									</div>
								</div>
								<div class="deposit-conditions__item">
									<div class="deposit-conditions__item-block">Минимальная сумма вклада</div>
									<div class="deposit-conditions__item-block">
										1 000 рублей / 50 долларов США
										/ 50 евро
									</div>
								</div>
								<div class="deposit-conditions__item">
							...
							<div class="deposit__text is-mob-block">
								<p>1. Вклад открывается клиентам при условии одновременного оформления договора накопительного и/или инвестиционного страхования жизни
									с компанией ООО "Страховая компания "Росгосстрах-Жизнь" или при условии одновременного приобретения пая (паев) ПИФ под управлением
									ООО «Управление Сбережениями».</p>
								<p>2. Сумма вклада должна быть: - не более суммы премии (взноса) по договорам накопительного или инвестиционного
									страхования жизни с единовременной уплатой взносов или четырехкратной суммы годовой премии (взноса)
									по договорам накопительного страхования жизни с периодической уплатой взносов, но не менее 100 000 рублей или
									- не более суммы одновременного приобретения пая (паев) ПИФ под управлением ООО «Управление Сбережениями».
									В случае наличия у вкладчика ранее приобретенного пая (паев), договор банковского вклада заключается при
									приобретения вкладчиком дополнительного пая (паев) на сумму, равную или превышающую сумму вклада.
									Вклад открывается в отделениях, осуществляющих прием заявок на операции с инвестиционными продуктами.</p>
							</div>
						</div>
					</div>
					<div class="deposit-info__right">
						<div class="deposit-open deposit-info__block">
							...
							<div class="deposit-open__methods">
								...
								<div class="deposit__text no-mob-block">
									<p>1. Вклад открывается клиентам при условии одновременного оформления договора накопительного и/или инвестиционного страхования жизни
										с компанией ООО "Страховая компания "Росгосстрах-Жизнь" или при условии одновременного приобретения пая (паев) ПИФ под управлением
										ООО «Управление Сбережениями».</p>
									<p>2. Сумма вклада должна быть: - не более суммы премии (взноса) по договорам накопительного или инвестиционного
