	...
	<div class="inner deposit">
		<div class="inner__banner">
			<div class="inner__banner-img">
				<div class="inner__banner-img-in" style="background-image: url('/static/theme/images/banners/deposit/Deposit_Investment.png');"></div>
			</div>
		...
		<div class="b-blocks">
			<?include "../includes/calcs/invest.php"?>
