	...
	<div class="inner deposit">
		<div class="inner__banner">
			<div class="inner__banner-img">
				<div class="inner__banner-img-in" style="background-image: url('/static/theme/images/banners/deposit/Deposit_Gosstrakh.png');"></div>
			</div>
			<div class="inner__banner-in grid__inner">
				<div class="inner__banner-block">
					<div class="inner__banner-title">Вклад «Госстраховский VIP»</div>
					<div class="breadcrumbs">
						...
						<div class="breadcrumbs__item">
							<span>Вклад «Госстраховский VIP»</span>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="numerals">
						<div class="numerals__block">
							<div class="numerals__item _big">
								<div class="numerals__item-val">8,10%</div>
		...
		<div class="b-blocks">
			<?include "../includes/calcs/gosstrakhVip.php"?>
						...
						<div class="deposit-info__block">
							...
							<div class="deposit-conditions">
								...
								<div class="deposit-conditions__item">
									...
									<div class="deposit-conditions__item-block">
										1 000 000 рублей / 15 000 долларов США
										/ 15 000 евро
									</div>
								</div>
								<div class="deposit-conditions__item">
								...
								<div class="deposit-conditions__item">
									...
									<div class="deposit-conditions__item-block">
										Автоматическая пролонгация по окончании срока вклада на тот же срок с учетом ставки
										по вкладу и ставки для досрочного расторжения, действующих в Банке по данному виду вклада на момент пролонгации
									</div>
								</div>
								<div class="deposit-conditions__item">
									<div class="deposit-conditions__item-block">
