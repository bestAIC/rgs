			...
			<div class="inner__banner-in grid__inner">
				<div class="inner__banner-block">
					...
					<div class="breadcrumbs">
						...
						<div class="breadcrumbs__item">
							<span>Вклад «Пенсионный доход»</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="grid__inner">
					...
					<div class="numerals">
						<div class="numerals__block">
							<div class="numerals__item _big">
								<div class="numerals__item-val">7,30%</div>
						...
						<div class="numerals__block">
							<div class="numerals__item _small">
								<div class="numerals__item-val">1,60%</div>
								<div class="numerals__item-dash"></div>
								<div class="numerals__item-text">
									ставка на вклад<br/>
									в долларах
							...
							<div class="numerals__item _small">
								<div class="numerals__item-val">0,80%</div>
								<div class="numerals__item-dash"></div>
								<div class="numerals__item-text">
									ставка на вклад<br/>
									в евро
				...
				<div class="inner__info-benefits">
					<div class="inner__info-benefits-title">
						Разработан специально для пенсионеров: высокий процент при небольших суммах с возможностью пополнения
					</div>
					<ul class="b-list">
						<li>Автоматическая пролонгация вклада по ставке, действующей на момент пролонгации</li>
						<li>Повышенный доход</li>
						<li>Ежемесячная выплата процентов</li>
						<li>Возможность пополнения вклада без ограничения сумм</li>
						<li>Низкий первоначальный взнос</li>
						<li>Срок вклада до 2-х лет</li>
					</ul>
